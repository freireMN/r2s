...
class R2S():
    ...
    def __init__(self, r2senv):
        ...
        self.ui_coo = R2S_coo(self.matrix.row, self.matrix.col, self.matrix.data, np.single).load_coo(self.data[self.matrix.source])
        
        
        #spa.coo_matrix((_data, (_row, _col)))
